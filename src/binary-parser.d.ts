...
declare module "binary-parser" {
	export interface Parser<O extends object | undefined = undefined> {
		...
		array<N extends string, Q extends Parser.ArrayOptions<O>>(name: N, options: Q): Parser.Next<O, N,
	...
	export namespace Parser {
		...
		interface ArrayOptions<O> extends Options {
			type: string | Parser<any>;
			length?: number | string | ((this: O) => number);
